...
public final class MySimpleGlyph extends Glyph {
	  public enum Offset {
		    // header
		    numberOfContours(0),
		    xMin(2),
  ...
  public MySimpleGlyph(ReadableFontData data, int offset, int length) {
    super(data, offset, length, GlyphType.Simple);
  }

  public MySimpleGlyph(ReadableFontData data) {
  ...
  public static class SimpleGlyphBuilder extends Glyph.Builder<MySimpleGlyph> {
    ...
    @Override
    protected MySimpleGlyph subBuildTable(ReadableFontData data) {
      return new MySimpleGlyph(data, 0, data.length());
    }
  }
}